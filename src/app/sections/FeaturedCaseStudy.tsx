...
const caseStudy = {
  ...
  approach: 'We architected the staking, referral, backend, and dashboard layers as one connected product. The work focused on Solidity contract structure, reward distribution reliability, backend event handling, and a dashboard experience that made wallet states and user actions easier to understand.',
  results: [
    { metric: '+28%', label: 'TVL growth tracked after launch' },
    { metric: 'Wallet', label: 'dashboard states clarified' },
    { metric: 'Review', label: 'internal risk pass completed' },
    { metric: 'Handoff', label: 'audit coordination prepared' },
  ],
}
      ...
      <div className="w-full px-6 md:px-12 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/3] bg-gradient-to-br from-violet-900/40 via-slate-900/30 to-purple-900/40 rounded-lg border border-border overflow-hidden relative">
              {/* Mock UI */}
            ...
            <div className="absolute -bottom-6 -right-6 bg-accent text-white p-6 rounded-lg shadow-2xl">
              ...
              <div className="font-mono text-label opacity-80 mt-1">Tracked TVL Growth</div>
            </div>
          </div>
