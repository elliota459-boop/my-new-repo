...
const projects = [
  {
    ...
    color: 'from-teal-600/25 via-cyan-500/10 to-slate-900',
    size: 'large',
  ...
  },
  {
    ...
    color: 'from-emerald-600/25 via-teal-500/10 to-slate-900',
    size: 'small',
  ...
  },
  {
    ...
    color: 'from-teal-600/20 via-slate-600/20 to-background-card',
    size: 'large',
