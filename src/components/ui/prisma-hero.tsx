  ...
  return (
    <section className="h-screen w-full p-2 md:p-4 lg:p-6">
      <div className="relative h-full w-full overflow-hidden rounded-2xl md:rounded-[2rem]">
        ...
        {/* Fallback background remains visible while video loads or if the remote media fails. */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(44,191,174,0.30),transparent_30%),radial-gradient(circle_at_80%_10%,rgba(221,161,94,0.16),transparent_28%),linear-gradient(135deg,#0B0F12,#12181C_45%,#151D22)]" />
